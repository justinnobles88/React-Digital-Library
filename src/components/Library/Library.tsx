...
import { Drawer as MUIDrawer, ListItem, List, ListItemIcon, ListItemText, Theme, useTheme, makeStyles, createStyles, AppBar, Toolbar, IconButton, Typography, Divider, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle,} from '@material-ui/core';
...
export const Library = withRouter (( props:LibraryProps) => {
    ...
    const itemsList = [
        ...
        {
            text: 'Sign In',
            onClick: () => history.push('https://wisdomlibrary.herokuapp.com/signin')
        },        {
            text: 'About',
